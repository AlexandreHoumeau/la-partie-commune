                ...
                <CardContent className="p-6 space-y-6">
                    <div className="space-y-3">
                        <div className="flex justify-between items-center">
                            <Label htmlFor="context" className="font-bold text-slate-700">Contexte général</Label>
                            <Badge className="bg-blue-50 text-blue-700 border-none text-[10px] uppercase">Identité</Badge>
                        </div>
                        <Textarea
                            id="context"
                            name="context"
                            ...
                            className="min-h-[120px] bg-slate-50/50 border-slate-200 focus-visible:ring-blue-600"
                        />
                    </div>

                    <div className="space-y-3">
                        <Label htmlFor="keyPoints" className="font-bold text-slate-700">Arguments clés (un par ligne)</Label>
                        <Textarea
                            id="keyPoints"
                            name="keyPoints"
                            defaultValue={ai?.key_points || ""}
                            placeholder="- Disponibilité 7j/7&#10;- Visites virtuelles 3D&#10;- Honoraires réduits"
                            className="min-h-[100px] bg-slate-50/50 border-slate-200 focus-visible:ring-blue-600"
                        />
                    </div>
                </CardContent>
            </Card>
            ...
            <Card className="border-slate-100 shadow-sm">
                ...
                <CardContent className="p-6 space-y-8">
                    <div className="space-y-4">
                        <Label className="font-bold text-slate-700">Style de communication</Label>
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex flex-col items-center p-4 rounded-xl border-2 transition-all gap-2
                                            ${active ? 'border-blue-600 bg-blue-50/50 shadow-sm' : 'border-slate-100 bg-slate-50/30 hover:border-slate-200'}`}
                                    >
                                        <div className={`p-2 rounded-lg ${active ? 'bg-blue-600 text-white' : 'bg-white text-slate-400'}`}>
                                            <Icon className="size-5" />
                                        </div>
                                        <div className="text-center">
                                            <p className={`text-xs font-bold ${active ? 'text-blue-900' : 'text-slate-700'}`}>{option.label}</p>
                                        </div>
                                    </button>
                                )
                            })}
                    ...
                    <div className="space-y-3">
                        <Label htmlFor="instructions" className="font-bold text-slate-700">Instructions particulières</Label>
                        <Textarea
                            id="instructions"
                            name="instructions"
                            ...
                            className="bg-slate-50/50 border-slate-200 focus-visible:ring-blue-600"
                        />
                    </div>
                </CardContent>
