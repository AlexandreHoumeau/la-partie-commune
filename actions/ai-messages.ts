...
function buildStructuredEmailPrompt(params: {
	...
	return [
		...
		"- exemples de forme d'objet : Nom : un site à la hauteur de votre expertise | Nom : mieux présenter votre savoir-faire en ligne | Nom : rendre la prise de contact plus simple",
		"- évite les objets génériques ou plats comme Bonjour, Site web pour..., Prise de contact, Suite à..., Relance",
		"- intro = 1 phrase maximum sur l'agence expéditrice, en mentionnant explicitement le nom de l'agence si disponible",
		"- intro ne doit jamais décrire l'entreprise prospectée. Il est interdit d'écrire une phrase du type [Nom du prospect] accompagne...",
		...
		"- intro doit ressembler à une phrase de type : [Nom agence] accompagne des entreprises qui veulent créer ou faire évoluer leur site afin qu'il reflète mieux leur image, leur expertise ou leur savoir-faire",
		"- intro doit rester sobre et courte",
		...
		"- observation doit idéalement suivre cette logique : En découvrant [Entreprise], on comprend bien [point positif réel], mais le site pourrait [limite diplomatique].",
		...
		"- n'utilise jamais les formules suivantes dans ces 6 champs : J'espère que vous allez bien, Il y aurait un vrai potentiel pour, quelques pistes pour aller plus loin",
		...
		"- le rendu visé est un email court, net, crédible, lisible et aéré, pas un résumé minimaliste ni un texte de prospection standardisé",
