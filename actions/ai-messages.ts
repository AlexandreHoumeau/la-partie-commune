...
function buildStructuredEmailPrompt(params: {
	...
	return [
		...
		"- exemples de forme d'objet : Nom : un site plus clair pour vos clients | Nom : mieux presenter votre savoir-faire en ligne | Nom : rendre la prise de contact plus simple",
		"- évite les objets génériques ou plats comme Bonjour, Site web pour..., Prise de contact, Suite à..., Relance",
		"- intro = 1 phrase maximum sur l'agence expeditrice, en mentionnant explicitement le nom de l'agence si disponible",
		"- intro ne doit jamais decrire l'entreprise prospectee. Il est interdit d'ecrire une phrase du type [Nom du prospect] accompagne...",
		...
		"- intro doit etre sobre et courte, par exemple : [Nom agence] accompagne des entreprises qui veulent un site plus clair, plus credible et plus simple a faire vivre",
		...
		"- observation doit idealement suivre cette logique : En decouvrant [Entreprise], on comprend bien [point positif reel], mais le site pourrait [limite diplomatique].",
		...
		"- n'utilise jamais les formules suivantes : J'espere que vous allez bien, Il y aurait un vrai potentiel pour, quelques pistes pour aller plus loin",
		...
		"- le rendu vise un email court, net et credible, pas un texte de prospection standardise",
